...
from Dence.dence_pyramid import farneback_method

def main():
    parser = ArgumentParser()
    parser.add_argument(
        "--algorithm",
        choices=["lucaskanade", "lucaskanade_interactive" , "lucaskanade_manual" , "dence_pyramid_lk" , "dence_rlof" , "farneback"],
        required=True,
